...
export class MenuService {
  private flatMenuData: FlatItem[] = [
    ...
    { id: '3-1', parentId: '3', label: 'Property Developers', route: '/newhouse/property-developers' },
    { id: '3-2', parentId: '3', label: 'Real Estate', route: '/newhouse/real-estate' },
    
    { id: '3-2-1', parentId: '3-2', label: 'Regional', route: '/newhouse/regional' },
    { id: '3-2-2', parentId: '3-2', label: 'Housing Resource', route: '/newhouse/housing-resource' },
    { id: '3-2-3', parentId: '3-2', label: 'Unoccupied', route: '/newhouse/unoccupied' },
